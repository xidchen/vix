...
import subprocess
import sys
sys.path.append("/home/song/Documents/Codes/subtitle-flask-bar/vsr/")
import cv2
import tqdm
...
class SubtitleRemover:
    ...
    def __init__(
            self, vd_path, out_path,sub_area=None, gui_mode=False, start_t=None, end_t=None
    ):
        ...
        self.video_out_dir = os.path.join(self.out_path,"videos_no_sub")
...
def process_files_in_directory(
        directory,out_path, files, sub_area=None, start_t=None, end_t=None
):
    ...
    if sub_area is None or need_detection:
        ...
        sub_area,_ = detector.detect()
        sub_area = sub_area[0][0]
    processor = SubtitleRemover(
        file_path, out_path,sub_area=sub_area, start_t=start_t, end_t=end_t
    )
    processor.run()

def remove_main(videos_path,area=None,start_t=None,end_t=None):
    video_directory_path = os.path.join(videos_path,'videos')
    ...
    for video_path in video_paths:
        process_files_in_directory(
                video_directory_path, videos_path,video_path,subtitle_area,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dir",
        default="/home/song/Documents/Codes/vsr-lite/ss_video/videos_no_sub",
